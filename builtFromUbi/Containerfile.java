...
## time podman build -f Containerfile.java -t localhost/itrzzs/java11:$(date +"%Y.%V") --build-arg REL_BASEIMAGE="registry.redhat.io/ubi9/ubi-minimal:9.2-484" --build-arg JAVA_VERSION="java-11-openjdk" . 2>&1
##
